...
- **Counterbalance Physics:** Wormhole stability requires gravitational anchors. Sol's Jupiter provides natural counterbalance; artificial systems need AWS stations or asteroid placement at 180° opposite the exit point.
...
- **Counterbalance Engineering:** AWS stations serve as artificial counterbalances, using high-mass construction to stabilize wormhole tension. Placement at 180° opposite natural exits prevents asymmetric collapse.
...
- **EM Harvesting Network:** Natural wormholes become power sources for artificial stations. Sol's Jupiter-anchored NWH provides baseline EM for AWS construction and maintenance.
...
- **Counterbalance Survey:** AI Manager evaluates new systems for natural gravitational anchors (Jupiter-class bodies) before committing to wormhole stabilization investments.
