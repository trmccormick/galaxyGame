# [ARCHIVED 2026-04-17]
# This file has been superseded by 2026-04-17-CRITICAL-FIX-MONITOR-LOADING.md and is retained for historical reference only.
# All actionable requirements have been extracted and rewritten in the canonical template.
# Do not implement from this file; see the new task for current requirements and acceptance criteria.
