...
**Final test result**: terraforming_manager_spec.rb: 12 examples, 0 failures. No regressions in ai_manager specs. No migration generated.

### What was changed
- Updated depot_adapter.rb to ensure CelestialLocation.create! always passes a unique name using NameGeneratorService#generate_identifier.

### Issues discovered
- None after fix. All related specs pass.

### Follow-up tasks needed
- None required for this fix.

### Lessons learned
- Always check for required attributes on model creation, especially when validations are enforced at the DB level.
- Use existing services for unique identifier generation to avoid collisions and validation errors.
