...
**Final test result**: 5 examples, 0 failures (Job model spec)

### What was changed
- Unified Job model migration and factory created in correct paths
- Job model association fixed to use Settlement::BaseSettlement
- Migration run and table created successfully
- All Job model specs pass

### Issues discovered
- Initial migration referenced wrong table name (settlements instead of base_settlements)
- Factory and migration were outside application path; fixed
- Association needed explicit class_name

### Follow-up tasks needed
- Proceed with further integration and legacy model retirement as per architecture plan

### Lessons learned
- Pathing and explicit association class names are critical for legacy Rails codebase migrations