# 2026-04-06-MEDIUM-ARCHITECTURE-HYDROSPHERE STATE DISTRIBUTION FALLBACK AND DOC UPDATE
...
Many existing and generated star system JSON files use different formats for `hydrosphere_attributes.state_distribution`...
