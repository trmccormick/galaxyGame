# 2026-04-02-HIGH-ARCHITECTURE-REFACTOR TERRAFORMING MANAGER IDENTIFY AVAILABLE RESOURCES
...
## Problem
TerraformingManager#identify_available_resources is hardcoded to specific planet names (@worlds[:venus], @worlds[:...
