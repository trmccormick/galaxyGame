# 2026-04-17-MEDIUM-FEATURE-FIX TERRAIN GRID RENDERING MISMATCH
...
## Issue Summary
The terrain rendering system for small celestial bodies like Luna (the moon) does not display surface features like craters du...
