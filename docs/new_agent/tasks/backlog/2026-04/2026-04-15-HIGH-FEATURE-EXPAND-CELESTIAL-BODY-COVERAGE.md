# 2026-04-15-HIGH-FEATURE-EXPAND CELESTIAL BODY COVERAGE
...
## Problem
Currently, terrain generation is focused on the main Sol worlds (Venus, Earth, Mars, Luna, Titan). However, the system should be able to generate r...
