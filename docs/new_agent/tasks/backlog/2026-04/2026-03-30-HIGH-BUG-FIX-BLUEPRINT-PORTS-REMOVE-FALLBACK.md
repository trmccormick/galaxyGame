...
**Why This Agent**: Requires architectural reasoning — blast radius across all craft models, blueprint lookup chain, and settlement port hubs
...
## Commit Instructions
**Commit message format**: `fix: remove blueprint ports fallback and hardcoded satellite lookup`
