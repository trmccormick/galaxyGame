# 2026-04-04-MEDIUM-ARCHITECTURE-DYNAMIC SURFACE LIQUID COVERAGE
...
## Problem
Currently, `surface_liquid_coverage` is a fixed value in the JSON and view for bodies like Earth and Titan. This does not reflect real-time or...
