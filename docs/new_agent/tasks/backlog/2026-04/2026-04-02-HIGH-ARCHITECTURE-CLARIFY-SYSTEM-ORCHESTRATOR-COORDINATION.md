# 2026-04-02-HIGH-ARCHITECTURE-CLARIFY SYSTEM ORCHESTRATOR COORDINATION
...
## Problem
The SystemOrchestrator (Phase 5) for wormhole expansion has unclear multi-settlement coordination logic. The docume...
