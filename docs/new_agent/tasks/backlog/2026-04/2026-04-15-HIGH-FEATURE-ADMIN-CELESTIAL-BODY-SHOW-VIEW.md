# 2026-04-15-HIGH-FEATURE-ADMIN CELESTIAL BODY SHOW VIEW
...
## Problem Description
In the admin simulation page (`/admin/simulation`), the "View" link redirects to the public celestial body view instead of an admin v...
