# 2026-04-02-HIGH-ARCHITECTURE-REDESIGN ADMIN CELESTIAL BODIES EDIT PAGE
...
## Problem
The current edit page (`/admin/celestial_bodies/:id/edit`) is overcomplicated and incorrectly designed. It mixes basic property editing with com...
