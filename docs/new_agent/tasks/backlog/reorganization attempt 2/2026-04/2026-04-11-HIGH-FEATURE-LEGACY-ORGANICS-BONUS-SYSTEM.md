# 2026-04-11-HIGH-FEATURE-LEGACY ORGANICS BONUS SYSTEM
...
## 🎯 **Task Overview**
Implement the +20% biomass production bonus for Worldhouses constructed in organic-rich regions, leveraging existing biosphere `so...
