# 2026-04-13-HIGH-FEATURE-IMPROVE CELESTIAL BODIES NUMBER FORMATTING
...
## Problem Description
The admin celestial bodies index view at `/admin/celestial_bodies` displays mass values as very large raw numbers (e....
