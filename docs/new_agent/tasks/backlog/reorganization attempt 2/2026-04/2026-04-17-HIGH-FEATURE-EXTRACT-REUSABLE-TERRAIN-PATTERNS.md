# 2026-04-17-HIGH-FEATURE-EXTRACT REUSABLE TERRAIN PATTERNS
...
## Problem
Current terrain system loads full GeoTIFF files (~140MB) at runtime. This creates performance issues and storage dependencies. We need...
