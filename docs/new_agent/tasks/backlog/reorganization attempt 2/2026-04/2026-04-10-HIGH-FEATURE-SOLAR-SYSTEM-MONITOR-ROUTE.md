# 2026-04-10-HIGH-FEATURE-SOLAR SYSTEM MONITOR ROUTE
...
## Problem Description
The admin dashboard has a "MONITOR" button for solar systems that links to `/admin/solar_systems/:id/monitor`, but this r...
