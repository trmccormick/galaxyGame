# 2026-04-10-HIGH-FEATURE-FIX TERRAIN PIXELATION RESOLUTION
...
## Problem
Current terrain rendering uses a fixed 80×50 grid with 8-pixel tiles for ALL celestial bodies, causing severe pixelation. Small bodies like L...
