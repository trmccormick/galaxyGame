# 2026-04-16-HIGH-FEATURE-REDIRECT ADMIN SIMULATION TO DIGITAL TWINS
...
## Problem Description
The current `/admin/simulation` page provides manual TerraSim controls that are misaligned with admin needs. Individual body...
