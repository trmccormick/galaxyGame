# 2026-04-02-HIGH-ARCHITECTURE-AI MANAGER PRIORITY CONTROLS
...
## Problem
The admin simulation page lacks controls for adjusting AI manager priorities during testing phases. Currently, AI priorities are...
