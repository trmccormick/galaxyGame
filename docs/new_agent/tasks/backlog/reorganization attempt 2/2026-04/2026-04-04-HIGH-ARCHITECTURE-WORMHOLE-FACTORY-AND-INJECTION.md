# 2026-04-04-HIGH-ARCHITECTURE-WORMHOLE FACTORY AND INJECTION
...
1. Background
The current Wormhole model (app/models/wormhole.rb) uses a basic after_create callback to generate random endpoints within a so...
