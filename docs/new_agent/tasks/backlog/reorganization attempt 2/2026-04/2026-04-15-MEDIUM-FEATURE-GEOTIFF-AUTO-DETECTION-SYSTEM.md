# 2026-04-15-MEDIUM-FEATURE-GEOTIFF AUTO DETECTION SYSTEM
...
## Problem
Currently, adding new GeoTIFF files requires manual intervention to regenerate terrain. The system doesn't automatically detect when ne...
