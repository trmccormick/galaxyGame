# 2026-04-13-HIGH-FEATURE-REFINE TIME CONTROLS FOR AI TESTING
...
## Problem Description
The TIME CONTROLS section in admin simulation is intended for AI testing scenarios but uses confusing "tick" terminology and may be better...
