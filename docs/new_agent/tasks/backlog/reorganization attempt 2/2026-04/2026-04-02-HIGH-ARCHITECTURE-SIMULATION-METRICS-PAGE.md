# 2026-04-02-HIGH-ARCHITECTURE-SIMULATION METRICS PAGE
...
## Problem Description
The "View Metrics" button in admin simulation currently redirects to the admin dashboard but is labeled as if it shows simulation met...
