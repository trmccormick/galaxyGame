...
**Why This Agent**: Requires architectural reasoning across geosphere, celestial body composition data, and manufacturing service layer
...
## Commit Instructions
**Commit message format**: `refactor: use geosphere-driven volatile yields in MaterialProcessingService`

**Files to commit**:
- `app/services/manufacturing/material_processing_service.rb`
- `app/models/celestial_bodies/geosphere.rb`
