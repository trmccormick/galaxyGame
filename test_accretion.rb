...
require_relative 'galaxy_game/app/services/star_sim/procedural_generator'
require_relative 'galaxy_game/app/services/star_sim/accretion_simulation_service'
