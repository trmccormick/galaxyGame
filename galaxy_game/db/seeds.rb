...
atmospheres = [
  { 
    ...
    dust: { concentration: 0.1, properties: "Mainly composed of silicates and sulfates." },
    pressure: 92.0, 
  ...
  { 
    ...
    dust: { concentration: 0.5, properties: "Predominantly composed of iron oxide." },
    pressure: 0.006, 
  ...
  { 
    ...
    dust: { concentration: 0.2, properties: "Composed of organic compounds and tholins." },
    pressure: 1.5, 
  ...
  { 
    ...
    dust: { concentration: 0.05, properties: "Primarily nitrogen ice and frozen methane." },
    pressure: 0.014, 
  ...
  { 
    ...
    dust: { concentration: 0.01, properties: "Trace amounts of silicates and ammonia." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.02, properties: "Mainly composed of water ice and ammonia." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.01, properties: "Contains methane ice particles." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.01, properties: "Primarily composed of methane and ammonia ice." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.1, properties: "Contains frozen nitrogen and methane." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.01, properties: "Trace amounts of nitrogen ice." },
    pressure: 0, 
  ...
  { 
    ...
    dust: { concentration: 0.05, properties: "Mainly composed of hydrated minerals." },
    pressure: 0, 
...
atmospheres.each do |atmosphere|
  ...
  # verify the atmosphere matches our seed data  
  # if celestial_body.atmosphere.atmosphere_composition != atmosphere[:atmosphere_composition]
  #   puts "Atmosphere composition does not match for #{celestial_body.name}"
  #   puts "Expected: #{atmosphere[:atmosphere_composition]}"
  #   puts "Actual: #{celestial_body.atmosphere.atmosphere_composition}"

  #   # raise error and abort further seeding
  #   raise "Atmosphere composition does not match for #{celestial_body.name}"
  # end
end
