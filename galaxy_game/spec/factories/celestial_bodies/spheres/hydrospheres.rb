FactoryBot.define do
  factory :hydrosphere, class: 'CelestialBodies::Spheres::Hydrosphere' do
    ...
    # JSONB field values
    water_bodies { { 'oceans' => 0.0, 'lakes' => 0.0, 'rivers' => 0.0, 'ice_caps' => 0.0, 'groundwater' => 0.0 } }
    ...
    trait :earth do
      water_bodies { { 'oceans' => 1.0, 'lakes' => 0.5, 'rivers' => 0.2, 'ice_caps' => 0.1, 'groundwater' => 0.2 } }
      total_water_mass { 1.386e21 }
      state_distribution { { 'liquid' => 95.0, 'solid' => 5.0, 'vapor' => 0.0 } }
    end

    # Add a trait for mars-like hydrosphere
    trait :mars do
      water_bodies { { 'oceans' => 0.0, 'lakes' => 0.0, 'rivers' => 0.0, 'ice_caps' => 0.5, 'groundwater' => 0.5 } }
      total_water_mass { 1.0e18 }
