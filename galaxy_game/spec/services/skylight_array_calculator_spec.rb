...
RSpec.describe SkylightArrayCalculator, type: :service do
  ...
  describe ".calculate_materials" do
    it "calculates required 3D-printed I-beams from regolith" do
      materials = SkylightArrayCalculator.calculate_materials(skylight, blueprint)
  ...
  describe ".calculate_printer_requirements" do
    it "calculates required 3D printer capacity" do
      requirements = SkylightArrayCalculator.calculate_printer_requirements(skylight)
  ...
  describe ".estimate_construction_time" do
    it "estimates construction time based on skylight size" do
      hours = SkylightArrayCalculator.estimate_construction_time(skylight)
      ...
      expect(hours).to be_within(50).of(1625)  # Changed from 524 to 1625
    end
  end
end
