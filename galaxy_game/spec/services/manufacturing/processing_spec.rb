...
RSpec.describe Manufacturing::Processing, type: :service do
  ...
  let(:service) { Manufacturing::Processing.new(owner, "Algae Bioreactor Blueprint") }
  ...
  describe '#process' do
    ...
    context 'when owner does not have enough GCC' do
      before do
        owner.account.withdraw(95_001.0, "Testing insufficient funds")
      end
