...
RSpec.describe Storage::SurfaceStorage, type: :model do
  ...
  let(:location) { Location::CelestialLocation.find_or_create_by!(coordinates: "89.90°S 0.00°E", celestial_body: celestial_body) do |loc| loc.name = "Shackleton Crater Base" end }
