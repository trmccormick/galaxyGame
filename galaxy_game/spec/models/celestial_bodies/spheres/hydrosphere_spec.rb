...
RSpec.describe CelestialBodies::Spheres::Hydrosphere, type: :model do
  ...
  describe 'validations' do
    it { should validate_numericality_of(:total_water_mass).is_greater_than_or_equal_to(0).allow_nil }
  ...
  describe '#reset' do
    it 'resets to base values' do
      ...
      # Use a more flexible comparison for total_water_mass since it may be slightly modified during simulation
      expect(hydrosphere.total_water_mass).to be_within(1.0).of(1000.0)
    end
  end
