...
RSpec.describe RouteProposalVote, type: :model do
  ...
  it 'is valid with valid attributes' do
    vote = described_class.new(route_proposal: proposal, voter: voter, vote: 'approve', voting_power: 1000)
    expect(vote).to be_valid
  end

  it 'is invalid with an invalid vote value' do
    vote = described_class.new(route_proposal: proposal, voter: voter, vote: 'maybe', voting_power: 1000)
