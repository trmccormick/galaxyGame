module Manufacturing
  module Construction
  class DomeService
    def initialize(entity, crater_dome, service_provider = nil, panel_type = nil, currency = nil)
      @entity = entity
      ...
      @currency = currency || (@settlement.respond_to?(:currency) ? @settlement.currency : nil)
    end
    ...
    def process_contractor_payment(construction_job)
      ...
      # Use currency from @currency or fallback to nil
      currency = @currency
      begin
